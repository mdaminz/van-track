    ...
    <div class="card mb-3">
        <div class="card-body">
            <div class="row flex-between-center">
                <div class="col-md">
                    <h5 class="mb-2 mb-md-0">Create Van</h5>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="card mb-3">
                ...
                <div class="card-body bg-light">
                    <form action="{{ 'add_van_info' }}" method="POST" class="row g-3 needs-validation" novalidate=""
                        enctype="multipart/form-data">
                        @csrf

                        <div class="col-md-6">
                            <label class="form-label" for="validationCustom02">License Plate</label>
                            <input name="license_plate" class="form-control" id="validationCustom02" type="text"
                                required="" />
                        ...
                        <div class="col-md-6">
                            ...
                            <input name="capacity" class="form-control" id="validationCustom03" type="text" required="" />
