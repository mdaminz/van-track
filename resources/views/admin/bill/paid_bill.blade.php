                    ...
                    <tbody class="list" id="table-student">
                        ...
                        @foreach ($paidBills as $paidBills)
                            <tr class="btn-reveal-trigger">
                                ...
                                <td class="parent align-middle"><a href="profile_detail/{{ $paidBills->user->id }}">{{ $paidBills->user->name }}</a></td>
                                <td class="name align-middle"><a href="detail_student/{{ $paidBills->student->id }}">{{ $paidBills->student->full_name }}</a></td>
                                <td class="address align-middle">{{ $paidBills->student->district }}</td>
