                    ...
                    <div class="navbar-vertical-content scrollbar">
                        <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                            ...
                            <li class="nav-item">
                                ...
                                <!-- parent pages--><a class="nav-link" href="admin_calendar" role="button">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="nav collapse false" id="email">
                                    <li class="nav-item"><a class="nav-link" href="/view_vandriver">
                                            <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Van
                                                    Driver</span>
                                            </div>
                                        </a>
                                        <!-- more inner pages-->
                                    </li>
                                    <li class="nav-item"><a class="nav-link" href="view_parent">
                                            <div class="d-flex align-items-center"><span
                                                    class="nav-link-text ps-1">Parents</span>
                                            </div>
                                        </a>
                                        <!-- more inner pages-->
                                    </li>
                                                ...
                                                <div class="list-group-item">
                                                    <a class="notification notification-flush" href="admin_view_feedback">
                                                        ...
                                                        <div class="notification-body">
                                                            ...
                                                            <span class="me-2" role="img" aria-label="Emoji">🆕</span>
                                                            {{ $feedbackData->created_at->diffForHumans() }}
