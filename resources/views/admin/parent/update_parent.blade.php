        ...
        <div class="col-lg-12">
            <div class="card mb-3">
                ...
                <div class="card-body bg-light">
                    <form action="{{ url('edit_parent', $parent_data->id) }}" method="POST" class="row g-3 needs-validation"
                        novalidate="" enctype="multipart/form-data">
                        @csrf
                        <div class="col-md-12">
                            <label class="form-label" for="validationCustom01">Full Name</label>
                            <input value="{{ $parent_data -> name }}" name="name" class="form-control"
                                id="validationCustom01" type="text" required="" />
                            <div class="invalid-feedback">Enter full name.</div>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label" for="validationCustom02">Email</label>
                            <input value="{{ $parent_data -> email }}" name="email" class="form-control"
                        ...
                        <div class="col-md-6">
                            ...
                            <input value="{{ $parent_data -> phone }}" name="phone" class="form-control"
                        ...
                        <div class="col-md-6">
                            ...
                            <input value="{{ $parent_data -> address }}" name="address" class="form-control"
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="status" class="form-select" id="validationCustom07" required="">
                                <option selected="value={{ $parent_data->status }}" selected>
                                    {{ $parent_data->status }}</option>
