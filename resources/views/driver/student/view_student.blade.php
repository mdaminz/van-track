...
@section('body-content')
    ...
    <div class="card mb-3" id="table-student"
        ...
        <div class="card-header">
            <div class="row flex-between-center">
                ...
                <div class="col-8 col-sm-auto ms-auto text-end ps-0 d-flex align-items-center gap-2 justify-content-end">
                    <!-- Rate Filter -->
        ...
        <div class="card-body p-0">
            <div class="table-responsive scrollbar">
                <table class="table table-sm table-striped fs--1 mb-0 overflow-hidden">
                    ...
                    <tbody class="list" id="table-student-body">
                        @php $number = 1; @endphp
    ...
    <!-- JS to Filter by Rate -->
    <script>
        // Rate filter functionality
        const rateSelect = document.getElementById('rate-select');

        rateSelect.addEventListener('change', function () {
            const selectedRate = this.value;
            const rows = document.querySelectorAll("#table-student-body tr");

            rows.forEach(row => {
                const rateValue = row.getAttribute("data-rate");
