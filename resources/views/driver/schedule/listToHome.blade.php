...
@section('body-content')
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <p class="fs--1 mb-1">Pickup Time to School:
                                <strong>{{ \Carbon\Carbon::parse($rate->start_time)->format('g:i a') }}</strong>
                            </p>
                            <p class="fs--1 mb-1">Pickup Time to Home:
                                <strong>{{ \Carbon\Carbon::parse($rate->start_time)->format('g:i a') }}</strong>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-auto flex-lg-grow-1 flex-lg-basis-0 align-self-center">
                    <h5>Student Address
                        <span style="margin-left: 10px"
                            class="badge rounded-pill badge-soft-primary">{{$driver->van->license_plate}}</span>
                    </h5>
                </div>
            </div>
        </div>
    ...
    <script>
        function refreshHomeStudentTable(rateId) {
            fetch(`/students/to-home/${rateId}/data`)
        ...
        // Auto refresh every 30 seconds or call manually
        setInterval(() => {
            refreshHomeStudentTable({{ $rate->id }});
        }, 30000);
    </script>
