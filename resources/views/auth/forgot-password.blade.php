        ...
        <div class="container-fluid">
            ...
            <div class="row min-vh-100 bg-100">
                <div class="col-6 d-none d-lg-block position-relative">
                    <div class="bg-holder"
                        style="background-image:url(../../../homepage/img/carousel-2.jpeg);background-position: 50% 20%;">
                    </div>
                                ...
                                <div class="card-body p-4">
                                    <div class="row flex-between-center">
                                        ...
                                        <div class="col-auto">
                                            ...
                                            <h6 style="font-weight: 500;">Forgot your password? No problem. Just let us
                                        ...
                                        {{-- <div class="col-auto fs--1 text-600"><span class="mb-0 fw-semi-bold">New
                                                User?</span> <span><a href="/register">Create
                                                    account</a></span>
                                        </div>
                                    ...
                                    <form method="POST" action="{{ route('password.email') }}">
                                        ...
                                        <div class="mb-3">
                                            <button class="btn btn-primary d-block w-100 mt-3" type="submit"
                                                name="submit">Email Password Reset Link</button>
                                        </div>
                                    </form>
