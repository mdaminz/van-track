...
<body>
        ...
        <div class="row gx-0 d-none d-lg-flex">
            <div class="col-lg-7 px-5 text-start">
                <div class="h-100 d-inline-flex align-items-center py-3 me-4">
                    ...
                    <small>16 Jalan SS9/3, Petaling Jaya, Selangor</small>
                </div>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        <a href="/" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
            <h2 class="m-0 text-primary">VanTrack</h2>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <!-- Sign In button for small screens, visible only in collapsed menu -->
                <a href="login" class="btn btn-primary w-100 h-100 mt-2 d-lg-none">
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>16 Jalan SS9/3, Petaling Jaya, Selangor
                    </p>
                    <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+017 653 2057</p>
                    <p class="mb-2"><i class="fa fa-envelope me-3"></i>vantrack@gmail.com</p>
