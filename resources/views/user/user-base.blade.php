            ...
            <nav class="navbar navbar-light navbar-vertical navbar-expand-xl">
                ...
                <div class="d-flex align-items-center">
                    <div class="toggle-icon-wrapper">
                        ...
                        <div class="d-flex align-items-center py-3"><span class="font-sans-serif">VanTrack</span>
                        </div>
                    </a>
                </div>
                        ...
                        <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                            ...
                            <li class="nav-item">
                                ...
                                <div class="row navbar-vertical-label-wrapper mt-3 mb-2">
                                    <div class="col-auto navbar-vertical-label">Manage Children
                                    </div>
                                    <div class="col ps-0">
                                        <hr class="mb-0 navbar-vertical-divider" />
                                    </div>
                                </div>
                                <!-- parent pages--><a class="nav-link" href="view_student" role="button">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                                class="fab fa-odnoklassniki"></span></span><span
                                            class="nav-link-text ps-1">Children</span>
                                    </div>
                                </a>



                                <!-- parent pages--><a class="nav-link" href="parent_view_attendance" role="button">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                ...
                                <ul class="nav collapse false" id="events">
                                    <li class="nav-item"><a class="nav-link" href="/">
                                            <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Pay
                                                    Fees</span>
                                            </div>
                                        </a>
                                        <!-- more inner pages-->
                                    </li>
                                    <li class="nav-item"><a class="nav-link" href="/user_view_bill">
                                            <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Fee
                                                    History</span>
                                            </div>
                                        </a>
                                        <!-- more inner pages-->
                            ...
                            <li class="nav-item">
                                ...
                                <!-- parent pages--><a class="nav-link" href="view_van" role="button">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                                class="fas fa-caravan"></span></span><span
                                            class="nav-link-text ps-1">Track
                                            Van</span>
                                    </div>
                                </a>
                            ...
                            <li class="nav-item">
                                <!-- label-->
                                <div class="row navbar-vertical-label-wrapper mt-3 mb-2">
                                    <div class="col-auto navbar-vertical-label">Report
                                    </div>
                                    <div class="col ps-0">
                                        <hr class="mb-0 navbar-vertical-divider" />
                                    </div>
                                ...
                                <!-- parent pages--><a class="nav-link" href="user_view_report" role="button">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                ...
                                <div class="card card-notification shadow-none">
                                    ...
                                    <div class="scrollbar-overlay" style="max-height:50rem">
                                        <div class="list-group list-group-flush fw-normal fs--1">
                                            <div class="list-group-title border-bottom">NEW BILLING</div>

                                            {{-- new bill --}}
                                            @foreach ($unpaid_bills as $unpaidBills)

                                                <div class="list-group-item">
                                                    <a class="notification notification-flush" href="user_view_bill">
                                                        <div class="notification-avatar">
                                                            <div class="avatar avatar-2xl me-3">
                                                                <img class="rounded-circle"
                                                                    src="{{$unpaidBills->user->profile_photo_path}}"
                                                                    alt="" />
                                                            </div>
                                                        </div>
                                                        <div class="notification-body">
                                                            <p class="mb-1">You has an unpaid bills
                                                                VNTRK{{$unpaidBills->id}} of RM {{$unpaidBills->amount}}!
                                                            </p>
                                                            <span class="me-2" role="img" aria-label="Emoji">🆕</span>
                                                            {{ $unpaidBills->created_at->diffForHumans() }}
                                            ...
                                            <div class="list-group-title border-bottom">PAID BILL</div>

                                            {{-- new bill --}}
                                            @foreach ($paid_bills as $paidBills)
                                                ...
                                                <div class="list-group-item">
                                                    <a class="notification notification-flush" href="user_view_bill">
                                                        <div class="notification-avatar">
                                                            <div class="avatar avatar-2xl me-3">
                                                                <img class="rounded-circle"
                                                                    src="{{$paidBills->user->profile_photo_path}}" alt="" />
                                                            </div>
                                                        </div>
                                                        <div class="notification-body">
                                                            <p class="mb-1">Your payment have been verified! Bills
                                                                VNTRK{{$paidBills->id}} of RM {{$paidBills->amount}}!
                                                            </p>
                                                            <span class="me-2" role="img" aria-label="Emoji">🆕</span>
                                                            {{ $paidBills->created_at->diffForHumans() }}
                                            ...
                                            <div class="list-group-title border-bottom">RESOLVED REPORT</div>
