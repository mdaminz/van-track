        ...
        <div class="card-body position-relative">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <p class="mb-0">Below is the list of all reports by you in the system.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card-header">
            <div class="row flex-between-center">
                <div class="col-4 col-sm-auto d-flex align-items-center pe-0">
                    ...
                    <a style="margin-left: 10px;" href="create_report" class="btn btn-falcon-default btn-sm">
                    ...
                    <tbody class="list" id="table-student">
                        ...
                        @foreach ($report_data as $report_data)
                            <tr class="btn-reveal-trigger">
                                ...
                                <td class="address align-middle" style="min-width: 10rem;">{{ \Carbon\Carbon::parse($report_data->resolved_at)->format('d M Y, h:i A') }}</td>
                                </td>
