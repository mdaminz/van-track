    ...
    <div class="card mb-3">
        <div class="card-body">
            <div class="row flex-between-center">
                <div class="col-md">
                    <h5 class="mb-2 mb-md-0">Create Student</h5>
                </div>
                <div class="col-auto">
                ...
                <div class="card-body bg-light">
                    <form action="{{ 'add_student' }}" method="POST" class="row g-3 needs-validation" novalidate=""
                        ...
                        <div class="col-md-12">
                            ...
                            <input name="full_name" class="form-control" id="validationCustom01" type="text" required="" />
                        ...
                        {{-- <div class="col-md-6">
                            <label class="form-label" for="validationCustom07">School</label>
                            <input name="address" class="form-control" id="validationCustom07" type="text" required="" />
                            <div class="invalid-feedback">Enter a School.</div>
                        </div> --}}
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input name="address" class="form-control" id="validationCustom05" type="text" required="" />
                            <div class="invalid-feedback">Enter an address.</div>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label" for="validationCustom07">Postcode</label>
                            <input name="postcode" class="form-control" id="validationCustom07" type="text" required="" />
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="invalid-feedback">Please select your house area.</div>
                        </div>
