                    ...
                    <form action="{{ url('edit_student', $student_data->id) }}" method="POST"
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="relationship" class="form-select" id="validationCustom03" required="">
                                <option selected="value={{ $student_data->relationship }}" selected>
                                    {{ $student_data->relationship }}</option>
                        ...
                        <div class="col-md-12">
                            ...
                            <input value="{{ $student_data->school }}" name="address" class="form-control" id="validationCustom07" type="text"
                                required="" />
