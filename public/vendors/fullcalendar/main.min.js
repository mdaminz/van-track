...
var FullCalendar = (function (e) {
    ...
    function w(e, t, n, r, o, i, a, s, l, u) {
        ...
        for (c = w; c--; ) null != C[c] && A(C[c], C[c]);
        if (b) for (c = 0; c < b.length; c++) O(b[c], b[++c], b[++c]);
    }
    function R(e, t) {
        return (
            (t = t || []),
    ...
    function A(e, t, n) {
        ...
        if (
            ...
            (r = e.ref) &&
                ((r.current && r.current !== e.__e) || O(r, null, t)),
    ...
    (i.__b = function (e) {
        ...
        (i.diffed = function (e) {
            ...
            t &&
                t.__H &&
                t.__H.__h.length &&
                ((1 !== F.push(t) && V === i.requestAnimationFrame) ||
                    (
    ...
    ((J.prototype = new E()).isPureReactComponent = !0),
    ...
    function te(e) {
        return (
            e &&
                ...
                (e.__k = e.__k && e.__k.map(te))),
            e
        );
    }
    function ne(e) {
        return e && ((e.__v = null), (e.__k = e.__k && e.__k.map(ne))), e;
    }
    function re() {
    ...
    (i.__e = function (e, t, n) {
        ...
        (re.prototype.render = function (e, t) {
            this.__b &&
                (this.__v.__k && (this.__v.__k[0] = te(this.__b)),
                (this.__b = null));
            var n = t.__e && g(y, null, e.fallback);
            return (
                n && (n.__h = null), [g(y, null, t.__e ? null : e.children), n]
            );
        });
    ...
    function le(e) {
        var t = this,
            n = e.i,
            r = g(se, { context: t.context }, e.__v);
        (t.componentWillUnmount = function () {
            var e = t.l.parentNode;
            e && e.removeChild(t.l), A(t.s);
        }),
            t.i && t.i !== n && (t.componentWillUnmount(), (t.h = !1)),
            e.__v
                ? t.h
                    ? ((n.__k = t.__k), L(r, n), (t.__k = n.__k))
    ...
    ((ie.prototype = new E()).__e = function (e) {
        var t = this,
            n = oe(t.__v),
            r = t.o.get(e);
        return (
    ...
    var ue =
        ...
        de = "undefined" != typeof Symbol ? /fil|che|rad/i : /fil|che|ra/i;
    ...
    var Ee = "undefined" != typeof globalThis ? globalThis : window;
    Ee.FullCalendarVDom
        ...
        : (Ee.FullCalendarVDom = {
              ...
              flushToDom: function () {
                  ...
                  (i.debounceRendering = function (e) {
                      ...
                      L(g(Se, {}), document.createElement("div"));
    ...
    var _e = /(top|left|right|bottom|width|height)$/i;
    function Te(e, t) {
    ...
    function Ge(e, t, n) {
        return n.func
            ? n.func(e, t)
            : qe(e[n.field], t[n.field]) * (n.order || 1);
    }
    function qe(e, t) {
        return e || t
            ? null == t
    ...
    function it(e, t) {
        return ht(e) === ht(t) ? Math.round(nt(e, t)) : null;
    }
    function at(e) {
        return pt([e.getUTCFullYear(), e.getUTCMonth(), e.getUTCDate()]);
    }
    function st(e, t, n, r) {
        var o = pt([t, 0, 1 + lt(t, n, r)]),
            i = at(e),
            a = Math.round(nt(o, i));
    ...
    function lt(e, t, n) {
        var r = 7 + t - n;
        return -((7 + pt([e, 0, r]).getUTCDay() - t) % 7) + r - 1;
    }
    function ut(e) {
        return [
            e.getFullYear(),
    ...
    function bt(e, t) {
        if (e === t) return !0;
        for (var n in e) if (gt.call(e, n) && !(n in t)) return !1;
        for (var n in t) if (gt.call(t, n) && e[n] !== t[n]) return !1;
        return !0;
    }
    function Ct(e, t) {
        var n = [];
        for (var r in e) gt.call(e, r) && (r in t || n.push(r));
        for (var r in t) gt.call(t, r) && e[r] !== t[r] && n.push(r);
        return n;
    }
    function wt(e, t, n) {
    ...
    function Tt(e, t, n) {
        var r = n.dateEnv,
            ...
            a = e.defs,
            s = e.instances;
        for (var l in ((s = yt(s, function (e) {
        ...
        a)) {
            ...
            if (u.recurringDef) {
                ...
                for (
                    var d = 0, p = kt(u, c, t, r, o.recurringTypes);
                    d < p.length;
                    d++
                ) {
                    var f = p[d],
                        h = vt(l, { start: f, end: r.add(f, c) });
                    s[h.instanceId] = h;
                }
            }
        }
    ...
    function Ut(e, t) {
        for (var n = null, r = 0; r < xt.length; r += 1) {
            ...
            if (t[o]) {
                var i = e[o] / t[o];
                if (!Xe(i) || (null !== n && n !== i)) return null;
                n = i;
    ...
    var qt = {
        ...
        Qt = (function () {
            function e(e) {
                ...
                for (var o in e)
                    o in qt
                        ? ((n[o] = e[o]), (r = Math.max(qt[o], r)))
                        : ((t[o] = e[o]), o in Yt && (r = Math.max(Yt[o], r)));
                (this.standardDateProps = t),
                    (this.extendedSettings = n),
                    (this.severity = r),
                    (this.buildFormattingFunc = jt(en));
            }
            return (
    ...
    var sn = {
            ...
            buttonIcons: gn,
            customButtons: gn,
            defaultAllDayEventDuration: It,
            defaultTimedEventDuration: It,
            nextDayThreshold: It,
            scrollTime: It,
    ...
    function mn(e, t, n, r) {
        for (
            var o = { defs: {}, instances: {} }, i = Hn(n), a = 0, s = e;
            a < s.length;
            a++
        ) {
            var l = Pn(s[a], t, n, r, i);
            l && yn(l, o);
        }
        return o;
    }
    ...
    var xn = { id: String, groupId: String, title: String, url: String },
        Mn = { start: gn, end: gn, date: gn, allDay: Boolean },
        In = r(r(r({}, xn), Mn), { extendedProps: gn });
    ...
    function Nn(e, t, n) {
        return void 0 === n && (n = Hn(t)), vn(e, n);
    }
    function Hn(e) {
        return r(r(r({}, wn), In), e.pluginHooks.eventRefiners);
    }
    ...
    function An(e) {
        var t = Math.floor(nt(e.start, e.end)) || 1,
            n = at(e.start);
        return { start: n, end: Qe(n, t) };
    }
    function Un(e, t) {
        void 0 === t && (t = It(0));
        var n = null,
        ...
        return (
            e.start && ((n = at(e.start)), r && r <= n && (r = Qe(n, 1))),
            { start: n, end: r }
        );
    }
    function Ln(e) {
        var t = Un(e);
        return nt(t.start, t.end) > 1;
    }
    function Wn(e, t, n, r) {
        return "year" === r
            ? It(n.diffWholeYears(e, t), "year")
            : "month" === r
            ? It(n.diffWholeMonths(e, t), "month")
            : rt(e, t);
    }
    function Vn(e, t) {
        var n,
    ...
    function Yn(e, t, n, r) {
        ...
        for (var m in o)
            for (var y = 0, E = Vn(o[m], n); y < E.length; y++) {
                var S,
                    D = E[y];
                f = u[(S = a[m]).defId];
                s.push({
        ...
        for (var c in i)
            for (var b = 0, C = Vn(i[c], n); b < C.length; b++) {
                D = C[b];
                s.push({
                    def: e.defs[c],
                    ui: u[c],
    ...
    function or(e, t, n, r, o, i, a) {
        ...
        var f = p.range.start,
            ...
            m = at(f).valueOf() === at(v).valueOf(),
            y = at(et(h, -1)).valueOf() === at(et(g, -1)).valueOf();
    ...
    var lr = { start: gn, end: gn, allDay: Boolean };
    function ur(e, t, n) {
        var o = (function (e, t) {
                var n = vn(e, lr),
                    o = n.refined,
    ...
    function dr(e, t, n) {
        return r(r({}, pr(e, t, n)), { timeZone: t.timeZone });
    }
    function pr(e, t, n) {
        return {
    ...
    function fr(e, t, n) {
        var r = Nn({ editable: !1 }, n),
            o = On(r.refined, r.extra, "", e.allDay, !0, n);
        return {
            def: o,
            ui: Jn(o, t),
            instance: vt(o.defId, e.range),
            range: e.range,
            isStart: !0,
            isEnd: !0,
        };
    ...
    function vr(e, t) {
        ...
        return (
            r(
                ...
                ((n = e),
                (o = t.dateEnv),
                r(r({}, pr(n.range, o, n.allDay)), { allDay: n.allDay }))
            ),
            i
        );
    }
    function gr(e, t, n) {
        ...
        return (
            e
                ? ((i = at(i)), (i = r.add(i, o.defaultAllDayEventDuration)))
    ...
    function mr(e, t, n, r) {
        ...
        for (var a in e.defs) {
            var s = e.defs[a];
            i.defs[a] = yr(s, o[a], n, r);
        }
        for (var l in e.instances) {
            var u = e.instances[l];
            s = i.defs[u.defId];
            i.instances[l] = Er(u, s, o[u.defId], n, r);
        }
        return i;
    }
    function yr(e, t, n, o) {
    ...
    function Er(e, t, n, o, i) {
        ...
        return (
            ...
            l &&
                (u.range = {
                    start: u.range.start,
                    end: gr(t.allDay, u.range.start, i),
                }),
            t.allDay &&
                (u.range = { start: at(u.range.start), end: at(u.range.end) }),
            u.range.end < u.range.start &&
                (u.range.end = gr(t.allDay, u.range.start, i)),
            u
        );
    }
    var Sr = (function () {
    ...
    function Cr(e) {
        return r(r(r({}, wn), Dr), e.pluginHooks.eventSourceRefiners);
    }
    function wr(e, t) {
        return (
            ...
            return (
                    ...
                    if (e instanceof _r) {
                        ...
                        return (
                            this.getCurrentData().eventStore.defs[n.defId] ||
                                (this.dispatch({
                                    type: "ADD_EVENTS",
                                    eventStore: yn({ def: n, instance: r }),
                                }),
                ...
                (e.prototype.getEventSources = function () {
                    var e = this.getCurrentData(),
                        t = e.eventSources,
                        n = [];
                    for (var r in t) n.push(new De(e, t[r]));
                    return n;
                }),
                (e.prototype.getEventSourceById = function (e) {
                    ...
                    for (var r in ((e = String(e)), n))
                        if (n[r].publicId === e) return new De(t, n[r]);
                    return null;
                }),
            ...
            return (
                ...
                (e.prototype.setDates = function (e, t, n) {
                    ...
                    if (
                        ...
                        !0 === n.allDay && (u = An(u));
                        var c = Wn(u.start, l, a, n.granularity);
                        if (r) {
                            var d = Wn(u.end, r, a, n.granularity);
                            (i = d),
                                (o = c).years === i.years &&
                                o.months === i.months &&
                                o.days === i.days &&
            ...
            return (
                ...
                (e.prototype.countDurationsBetween = function (e, t, n) {
                    ...
                    return n.years && null !== (r = this.diffWholeYears(e, t))
                        ...
                        : n.days && null !== (r = it(e, t))
                        ? r / Ot(n)
                        : (t.valueOf() - e.valueOf()) / At(n);
                }),
                ...
                (e.prototype.timestampToMarker = function (e) {
                    return "local" === this.timeZone
                        ...
                        ? pt(this.namedTimeZoneImpl.timestampToArray(e))
                        : new Date(e);
                }),
                (e.prototype.offsetForMarker = function (e) {
                    return "local" === this.timeZone
                        ? -ct(dt(e)).getTimezoneOffset()
                        : "UTC" === this.timeZone
                        ? 0
                        : this.namedTimeZoneImpl
                        ? this.namedTimeZoneImpl.offsetForArray(dt(e))
                        : null;
                }),
    ...
    function Vr(e) {
        var t = Lr(e.locale || "en", Ur([]).map);
        return new Hr(
            r(r({ timeZone: ln.timeZone, calendarSystem: "gregory" }, e), {
                locale: t,
            })
        );
    }
    ...
    var Kr = { defs: {}, instances: {} },
        $r = (function () {
            function e() {
                (this.getKeysForEventDefs = jt(this._getKeysForEventDefs)),
                    (this.splitDateSelection = jt(this._splitDateSpan)),
                    (this.splitEventStore = jt(this._splitEventStore)),
                    (this.splitIndividualUi = jt(this._splitIndividualUi)),
                    (this.splitEventDrag = jt(this._splitInteraction)),
                    (this.splitEventResize = jt(this._splitInteraction)),
            ...
            return (
                (e.prototype.splitProps = function (e) {
                    var t = this,
                        ...
                        u = {};
                    for (var c in ((this.eventUiBuilders = Et(
                        n,
                        function (e, n) {
                            return t.eventUiBuilders[n] || jt(Jr);
                        }
                    )),
                    n)) {
                        var d = n[c],
                    ...
                    if (e) {
                        var n = this._splitEventStore(
                            ...
                            i = function (r) {
                                t[r] ||
                                    (t[r] = {
                                        affectedEvents: n[r] || Kr,
                                        mutatedEvents: o[r] || Kr,
                                        isEvent: e.isEvent,
                                    });
                            };
                        for (var a in n) i(a);
    ...
    function to(e, t) {
        return (
            void 0 === t && (t = "day"),
            JSON.stringify({ date: Vt(e), type: t })
        );
    }
    var no,
        ro = null;
    ...
    function lo(e, t, n) {
        void 0 === t && (t = !1);
        var r = n ? e.getBoundingClientRect() : uo(e),
            o = so(e, t),
            i = {
    ...
    if (
        ...
        (yo.prototype.baseIconClass = ""),
        (yo.prototype.iconOverridePrefix = ""),
    ...
    var Eo = FullCalendarVDom.Component,
        ...
        _o = FullCalendarVDom.flushToDom,
        To = FullCalendarVDom.unmountComponentAtNode,
        ko = (function () {
            function e(e, t, n, o) {
                var i = this;
                (this.execFunc = e),
        ...
        xo = wo({});
    function Mo(e, t, n, r, o, i, a, s, l, u, c, d, p) {
        return {
            dateEnv: o,
            options: n,
            pluginHooks: a,
            ...
            createScrollResponder: function (e) {
                return new ko(e, u, It(n.scrollTime), n.scrollTimeReset);
            },
    ...
    var Io = (function (e) {
        ...
        return (
            ...
            (t.prototype.shouldComponentUpdate = function (e, t) {
                return (
                    this.debug &&
                        console.log(Ct(e, this.props), Ct(t, this.state)),
                    !wt(this.props, e, this.propEquality) ||
                        !wt(this.state, t, this.stateEquality)
                );
            }),
            (t.addPropsEquality = No),
            (t.addStateEquality = Ho),
            (t.contextType = xo),
            t
        );
    })(Eo);
    (Io.prototype.propEquality = {}), (Io.prototype.stateEquality = {});
    var Po = (function (e) {
        function t() {
            return (null !== e && e.apply(this, arguments)) || this;
        }
        return n(t, e), (t.contextType = xo), t;
    })(Io);
    function No(e) {
        ...
        return (
            ...
            (t.prototype.isValidSegDownEl = function (e) {
                return (
                    ...
                    !Ce(e, ".fc-event-mirror")
                );
            }),
            (t.prototype.isValidDateDownEl = function (e) {
                return !(
                    Ce(e, ".fc-event:not(.fc-bg-event)") ||
                    Ce(e, ".fc-more-link") ||
                    Ce(e, "a[data-navlink]") ||
                    Ce(e, ".fc-popover")
                );
    ...
    (Wo.prototype.classes = {
        ...
        (Wo.prototype.baseIconClass = "fc-icon"),
        ...
        (Wo.prototype.rtlIconClasses = {
            prev: "fc-icon-chevron-right",
            next: "fc-icon-chevron-left",
            prevYear: "fc-icon-chevrons-right",
            nextYear: "fc-icon-chevrons-left",
        }),
        (Wo.prototype.iconOverrideOption = "buttonIcons"),
        (Wo.prototype.iconOverrideCustomButtonOption = "icon"),
        (Wo.prototype.iconOverridePrefix = "fc-icon-");
    var Fo = (function (e) {
            function t() {
                var t = (null !== e && e.apply(this, arguments)) || this;
                return (
                    ...
                    (t.handleRootEl = function (e) {
                        Oo(t.rootElRef, e),
                            t.props.elRef && Oo(t.props.elRef, e);
                    }),
                    t
                );
            }
        ...
        zo = wo(0);
    function Bo(e) {
        return So(zo.Consumer, null, function (t) {
            return So(jo, r({ renderId: t }, e));
        });
    }
    var jo = (function (e) {
            function t() {
                var t = (null !== e && e.apply(this, arguments)) || this;
                return (t.innerElRef = bo()), t;
            }
            return (
                n(t, e),
                (t.prototype.render = function () {
                ...
                (t.prototype.renderInnerContent = function () {
                    var e = this.context.pluginHooks.contentTypeHandlers,
                        ...
                        o = Zo(t.content, t.hookProps),
                        i = null;
                    if (
                        (void 0 === o &&
                            (o = Zo(t.defaultContent, t.hookProps)),
                        void 0 !== o)
                    ) {
        ...
        Go = (function (e) {
            function t() {
                ...
                return (
                    (t.handleRootEl = function (e) {
                        (t.rootEl = e), t.props.elRef && Oo(t.props.elRef, e);
                    }),
                    t
                );
            }
    ...
    function Yo(e, t) {
        return "function" == typeof e && (e = e(t)), Cn(e);
    }
    function Zo(e, t) {
    ...
    function $o(e) {
        ...
        return (
            n.content &&
                ((t = n),
                (o = function (e) {
                    return So(xo.Consumer, null, function (n) {
                        return So(
                            Xo,
                            { viewSpec: n.viewSpec },
                            function (o, i) {
            ...
            function (e) {
                return (function (e, t, n, o, i) {
                    ...
                    return {
                        ...
                        buttonTextDefault:
                            p(i) || e.defaults.buttonText || p(ln) || e.type,
                    };
                })(e, a, t, n, o);
            }
        );
    ...
    var ei = (function () {
        ...
        return (
            ...
            (e.prototype.buildCurrentRangeInfo = function (e, t) {
                ...
                return (
                    r.duration
                        ...
                        : ((i = Lt((o = this.getFallbackDuration())).unit),
                          (a = this.buildRangeFromDuration(e, t, o, i))),
            ...
            (e.prototype.adjustActiveRange = function (e) {
                ...
                return (
                    r &&
                        (Ot(o) < 0 && ((a = at(a)), (a = n.add(a, o))),
                        Ot(i) > 1 &&
                            ((s = Qe((s = at(s)), -1)), (s = n.add(s, i)))),
                    { start: a, end: s }
                );
            }),
            (e.prototype.buildRangeFromDuration = function (e, t, n, r) {
                ...
                return (
                    Ot(n) <= 1 &&
                        this.isHiddenDay(o) &&
                        (o = at((o = this.skipHiddenDays(o, t)))),
                    d(),
            ...
            (e.prototype.buildRangeFromDayCount = function (e, t, n) {
                ...
                do {
                    (r = Qe(r, 1)), this.isHiddenDay(r) || (s += 1);
                } while (s < n);
    ...
    function ni(e, t, n, o) {
        ...
        switch (t.type) {
            ...
            case "FETCH_EVENT_SOURCES":
                return ai(
                    e,
                    t.sourceIds ? St(t.sourceIds) : li(e, o),
                    s,
                    t.isRefetch || !1,
                    o
                );
        ...
        return ai(
            ...
            yt(e, function (e) {
                return (function (e, t, n) {
                    if (!ui(e, n)) return !e.latestFetchId;
                    return (
            ...
            case "RECEIVE_EVENTS":
                return (function (e, t, n, r, o, i) {
                    if (t && n === t.latestFetchId) {
                        ...
                        return r && (a = Tt(a, r, i)), Dn(pi(e, t.sourceId), a);
                    }
                    return e;
    ...
    function mi(e, t, n, r, o) {
        ...
        return {
            headerToolbar: e.headerToolbar
                ? yi(e.headerToolbar, e, t, n, r, o, i)
                : null,
            footerToolbar: e.footerToolbar
                ? yi(e.footerToolbar, e, t, n, r, o, i)
                : null,
            viewsWithButtons: i,
        };
    }
            ...
            eventSourceDefs: [
                {
                    ...
                    fetch: function (e, t, n) {
                        ...
                        po(
                            e.eventSource.meta.bind(null, dr(e.range, r)),
                            function (e) {
                                t({ rawEvents: e });
                            },
                            n
        ...
        Uo({
            ...
            propSetHandlers: {
                dateProfile: function (e, t) {
                    t.emitter.trigger(
                        "datesSet",
                        r(r({}, dr(e.activeRange, t.dateEnv)), {
                            view: t.viewApi,
                        })
                    );
                },
        ...
        _i = (function () {
            function e(e, t) {
                (this.runTaskOption = e),
                    ...
                    (this.queue = []),
                    (this.delayedRunner = new Ri(this.drain.bind(this)));
            }
            return (
    ...
    var ki = (function () {
        function e(e) {
            var t = this;
            (this.computeOptionsData = jt(this._computeOptionsData)),
                (this.computeCurrentViewData = jt(
                    this._computeCurrentViewData
                )),
                (this.organizeRawLocales = jt(Ur)),
                (this.buildLocale = jt(Lr)),
                (this.buildPluginHooks = Lo()),
                (this.buildDateEnv = jt(xi)),
                (this.buildTheme = jt(Mi)),
                (this.parseToolbars = jt(mi)),
                (this.buildViewSpecs = jt(Jo)),
                (this.buildDateProfileGenerator = Gt(Ii)),
                (this.buildViewApi = jt(Pi)),
                (this.buildViewUiProps = Gt(Oi)),
                (this.buildEventUiBySource = jt(Ni, bt)),
                (this.buildEventUiBases = jt(Hi)),
                (this.parseContextBusinessHours = Gt(Ui)),
                (this.buildTitle = jt(Ti)),
                (this.emitter = new fo()),
                (this.actionRunner = new _i(
            ...
            qn(d.activeRange, c) || (c = d.currentRange.start);
            for (
                var p = {
                        dateEnv: o.dateEnv,
            ...
            for (
                var v = ti(o.calendarOptions, d, p),
                    g = {
            ...
            Ai(g, p) && this.emitter.trigger("loading", !0),
                (this.state = g),
                this.updateData(),
        ...
        return (
            ...
            (e.prototype._handleAction = function (e) {
                ...
                this.data &&
                    ...
                    (d = (function (e, t, n, r) {
                        ...
                        switch (t.type) {
                            ...
                            case "CHANGE_DATE":
                                if (
                                    !e.activeRange ||
                                    !qn(e.currentRange, t.dateMarker)
                                )
                    ...
                    qn(d.currentRange, c) || (c = d.currentRange.start);
                for (
                    var p = ni(n.eventSources, e, d, u),
                        f = ci(n.eventStore, e, p, d, u),
                        h =
                            (ri(p) &&
                        ...
                        E = {
                            ...
                            dateSelection: fi(n.dateSelection, e),
                            eventSelection: hi(n.eventSelection, e),
                            eventDrag: vi(n.eventDrag, e),
                            eventResize: gi(n.eventResize, e),
                        },
                        S = r(r({}, u), E),
                        D = 0,
            ...
            (e.prototype.processRawCalendarOptions = function (e, t) {
                var n = hn([ln, e, t]),
                    ...
                    u = this.buildPluginHooks(e.plugins || [], bi),
                    c = (this.currentCalendarOptionsRefiners = r(
                        r(r(r(r({}, sn), un), cn), u.listenerRefiners),
                        u.optionRefiners
                    )),
                    d = {},
                    p = hn([ln, l, e, t]),
                ...
                for (var m in p)
                    "plugins" !== m &&
                        (p[m] === h[m] || (dn[m] && m in h && dn[m](h[m], p[m]))
                            ? (f[m] = v[m])
                            : c[m]
                            ? ((f[m] = c[m](p[m])), (g = !0))
                            : (d[m] = h[m]));
            ...
            (e.prototype.processRawViewOptions = function (e, t, n, o, i) {
                var a = hn([ln, e.optionDefaults, n, o, e.optionOverrides, i]),
                    s = r(
                        r(r(r(r(r({}, sn), un), cn), fn), t.listenerRefiners),
                        t.optionRefiners
                    ),
                    l = {},
    ...
    function Mi(e, t) {
        return new (t.themeClasses[e.themeSystem] || Wo)(e);
    }
    function Ii(e) {
    ...
    function Ui(e) {
        return Br(e.options.businessHours, e);
    }
    function Li(e, t) {
        for (var n in e)
            console.warn(
            ...
            return (
                ...
                (e.prototype.insertEntryAt = function (e, t) {
                    ...
                    !n || this.levelCoords[n - 1] < t.levelCoord
                        ? (Gi(this.levelCoords, n, t.levelCoord),
                          Gi(this.entriesByLevel, n, [e]))
                        : Gi(this.entriesByLevel[n - 1], t.lateralEnd, e),
                        (this.stackCnts[Bi(e)] = t.stackCnt);
                }),
                (e.prototype.findInsertion = function (e) {
                    ...
                    for (
                        t = 0;
                        t < s && ((n = r[t]), a || !(n >= c + e.thickness));
                        t += 1
                    ) {
                        var p = o[t],
                            f = void 0,
                            h = qi(p, e.spanStart, zi);
                        for (
                            u = l = h[0] + h[1];
                            (f = p[u]) && f.spanStart < e.spanEnd;

                        )
                            (a ||
                                (c < n + f.thickness && c + e.thickness > n)) &&
                                ((d = f), (c = n + f.thickness)),
                                (u += 1);
                    }
                    return {
    ...
    var Ki = {},
        ...
        Ji = {},
        Qi = { startTime: It, duration: It, create: Boolean, sourceId: String };
    function ea(e) {
        var t = vn(e, Qi),
            n = t.refined,
            r = t.extra;
    ...
    var ta = (function (e) {
                ...
                return (
                    (n.handleSegClick = function (e, t) {
                        ...
                        if (i && r.isValidSegDownEl(e.target)) {
                            var a = Ce(e.target, ".fc-event-forced-url"),
        ...
        aa = (function (e) {
            function t() {
                var t = (null !== e && e.apply(this, arguments)) || this;
                return (
                    (t.buildViewContext = jt(Mo)),
                    (t.buildViewPropTransformers = jt(la)),
                    (t.buildToolbarProps = jt(sa)),
                    (t.handleNavLinkClick = Ie(
                        "a[data-navlink]",
    ...
    function sa(e, t, n, r, o, i) {
        ...
        return {
            title: i,
            activeButton: e.type,
            isTodayEnabled: a.isValid && !qn(t.currentRange, o),
    ...
    var ua = (function (e) {
        ...
        return (
            ...
            (t.prototype.render = function () {
                ...
                return Xr() || i.push("fc-liquid-hack"), e.children(i, o, r, n);
            }),
            (t.prototype.componentDidMount = function () {
            ...
            return (
                ...
                (t.prototype.render = function () {
                    var e = this.props,
                        ...
                        u = [da].concat(eo(l, o), e.extraClassNames || []),
    ...
    function ga(e) {
        var t = at(e);
        return { start: t, end: Qe(t, 1) };
    }
    var ma = (function (e) {
        function t() {
            var t = (null !== e && e.apply(this, arguments)) || this;
            return (t.createDayHeaderFormatter = jt(ya)), t;
        }
        return (
            n(t, e),
            (t.prototype.render = function () {
                ...
                return So(va, { unit: "day" }, function (e, t) {
                    return So(
                        "tr",
                        null,
                        i && i("day"),
    ...
    var Ea = (function () {
            ...
            return (
                (e.prototype.sliceRange = function (e) {
                    var t = this.getDateDayIndex(e.start),
                        n = this.getDateDayIndex(Qe(e.end, -1)),
                        r = Math.max(0, t),
                ...
                (e.prototype.getDateDayIndex = function (e) {
                    var t = this.indices,
                        n = Math.floor(nt(this.dates[0], e));
                    return n < 0
                        ? t[0] - 1
                        : n >= t.length
                        ? t[t.length - 1] + 1
        ...
        Da = (function () {
            function e() {
                (this.sliceBusinessHours = jt(this._sliceBusinessHours)),
                    (this.sliceDateSelection = jt(this._sliceDateSpan)),
                    (this.sliceEventStore = jt(this._sliceEventStore)),
                    (this.sliceEventDrag = jt(this._sliceInteraction)),
            ...
            return (
                ...
                (e.prototype._sliceInteraction = function (e, t, n, r) {
                    for (var o = [], i = 4; i < arguments.length; i++)
                        o[i - 4] = arguments[i];
                    if (!e) return null;
                    var a = Yn(e.mutatedEvents, t, ba(n, Boolean(r)), r);
                    return {
                ...
                (e.prototype.sliceEventRange = function (e, t) {
                    ...
                    this.forceDayIfListItem &&
                        ...
                        (n = { start: n.start, end: Qe(n.start, 1) });
                    for (
    ...
    function Ca(e, t, n) {
        ...
        for (var o in r) if (!Gn(t.validRange, r[o].range)) return !1;
        return Ra({ eventDrag: e }, n);
    }
    function wa(e, t, n) {
        return !!Gn(t.validRange, e.range) && Ra({ dateSelection: e }, n);
    }
    function Ra(e, t) {
            ...
            !(
                ...
                !(function (e, t, n, o) {
                    ...
                    var d =
                            ...
                            {
                                defs: v.defs,
                                instances: yt(v.instances, function (e) {
                                    return !g[e.instanceId];
                                }),
                            }),
                        p = d.defs,
                        f = d.instances,
                        h = $n(p, e.eventUiBases);
                    var v, g;
                    for (var m in u) {
                        var y = u[m],
                            E = y.range,
                    ...
                    !(function (e, t, n, o) {
                        ...
                        for (var f in s) {
                            ...
                            if (jn(u, h.range)) {
                                ...
                                if (p && !p(new _r(t, a[h.defId], h), null))
                                    return !1;
                            }
                        }
    ...
    var Ia = /^(visible|hidden)$/,
        Pa = (function (e) {
            function t() {
                var t = (null !== e && e.apply(this, arguments)) || this;
                return (
                    (t.handleEl = function (e) {
                        (t.el = e), Oo(t.props.elRef, e);
                    }),
                    t
                );
            }
            return (
                ...
                (t.prototype.needsXScrolling = function () {
                    if (Ia.test(this.props.overflowX)) return !1;
                    for (
                        var e = this.el,
                            t =
                ...
                (t.prototype.needsYScrolling = function () {
                    if (Ia.test(this.props.overflowY)) return !1;
                    for (
                        var e = this.el,
                            t =
        ...
        Na = (function () {
            ...
            return (
                ...
                (e.prototype.collect = function (e, t, n) {
                    return _t(this.currentMap, e, t, n);
                }),
    ...
    function Ha(e) {
        for (
            var t = 0, n = 0, r = Re(e, ".fc-scrollgrid-shrink");
            n < r.length;
            n++
        ) {
            var o = r[n];
    ...
    function Wa(e, t) {
        ...
        return So.apply(void 0, o(["colgroup", {}], n));
    }
    function Va(e) {
        return null == e ? 4 : e;
    }
    ...
    var Ya = (function (e) {
        function t() {
            var t = (null !== e && e.apply(this, arguments)) || this;
            return (
                (t.processCols = jt(function (e) {
                    return e;
                }, La)),
                (t.renderMicroColGroup = jt(Wa)),
        ...
        return (
            ...
            (t.prototype.render = function () {
                ...
                return So(
                    ...
                    Boolean(!h && d.length) &&
                        So.apply(void 0, o(["thead", {}], d)),
                    Boolean(!h && p.length) &&
                        So.apply(void 0, o(["tbody", {}], p)),
                    Boolean(!h && f.length) &&
                        So.apply(void 0, o(["tfoot", {}], f)),
                    h && So.apply(void 0, o(["tbody", {}], d, p, f))
                );
            }),
            (t.prototype.renderSection = function (e, t) {
                return "outerContent" in e
                    ? So(Co, { key: e.key }, e.outerContent)
                    : So(
                          "tr",
                          {
                              key: e.key,
    ...
    Ya.addStateEquality({
        scrollerClientWidths: bt,
        scrollerClientHeights: bt,
    });
    var Za = (function (e) {
            function t() {
                var t = (null !== e && e.apply(this, arguments)) || this;
            ...
            return (
                ...
                (t.prototype.render = function () {
                    var e = this.props,
                        ...
                        a = {
                            ...
                            isDraggable: !e.disableDragging && tr(r, t),
                            isStartResizable: !e.disableResizing && nr(r, t),
                ...
                (t.prototype.componentDidMount = function () {
                    Xn(this.elRef.current, this.props.seg);
                }),
                (t.prototype.componentDidUpdate = function (e) {
                    var t = this.props.seg;
                    t !== e.seg && Xn(this.elRef.current, t);
                }),
                t
            );
        })(Po),
    ...
    function Ka(e) {
        return So(
            ...
            e.timeText && So("div", { className: "fc-event-time" }, e.timeText),
            So(
                "div",
    ...
    var $a = function (e) {
            return So(xo.Consumer, null, function (t) {
                var n = t.options,
                    r = {
                        isAxis: e.isAxis,
    ...
    function es(e) {
        var t = e.date,
            n = e.dateEnv,
            o = Qr(t, e.todayRange, null, e.dateProfile);
        return r(
    ...
    var ts = (function (e) {
        function t() {
            var t = (null !== e && e.apply(this, arguments)) || this;
            return (
                (t.refineHookProps = Gt(es)), (t.normalizeClassNames = qo()), t
            );
        }
        return (
            n(t, e),
    ...
    function os(e) {
        return (
            e.event.title &&
            So("div", { className: "fc-event-title" }, e.event.title)
        );
    }
    var is = function (e) {
        return So(xo.Consumer, null, function (t) {
    ...
    function ds(e) {
        if (e.allDayDate)
            return { start: e.allDayDate, end: Qe(e.allDayDate, 1) };
        var t,
            n = e.hiddenSegs;
        return {
            start: ps(n),
    ...
    var vs = (function (e) {
        function t(t, n) {
            ...
            return (
                ...
                (o.el = t),
                (o.renderRunner = new Ri(o.handleRenderRequest)),
                new ki({
                    optionOverrides: n,
                    calendarApi: o,
        ...
        return (
            ...
            (t.prototype.updateSize = function () {
                e.prototype.updateSize.call(this), _o();
            }),
            ...
            (t.prototype.setClassNames = function (e) {
                if (!Bt(e, this.currentClassNames)) {
                    for (
            ...
            return (
                ...
                (e.prototype.tryStart = function (e) {
                    ...
                    return (
                        !(
                            !t ||
                            (this.handleSelector && !Ce(n, this.handleSelector))
                        ) &&
                        ((this.subjectEl = t),
                        (this.isDragging = !0),
                        (this.wasTouchScroll = !1),
    ...
    var Ds = (function () {
            ...
            return (
                ...
                (e.prototype.cleanup = function () {
                    this.mirrorEl &&
                        (be(this.mirrorEl), (this.mirrorEl = null)),
                        (this.sourceEl = null);
                }),
        ...
        Cs = (function (e) {
            function t(t, n) {
                return e.call(this, new go(t), n) || this;
            }
            return (
                n(t, e),
        ...
        ws = (function (e) {
            function t(t) {
                return e.call(this, new mo(), t) || this;
            }
            return (
                n(t, e),
                (t.prototype.getEventTarget = function () {
    ...
    var xs = (function () {
        ...
        return (
            ...
            (e.prototype.prepareHits = function () {
                this.offsetTrackers = Et(this.droppableStore, function (e) {
    ...
    function Ms(e, t) {
        return (
            (!e && !t) ||
            (Boolean(e) === Boolean(t) && cr(e.dateSpan, t.dateSpan))
        );
    }
    function Is(e, t) {
        for (
            ...
            function t(t) {
                ...
                (n.dragSelection = null),
                    ...
                    (n.handlePointerUp = function (e) {
                        n.dragSelection &&
                            (hr(n.dragSelection, e, n.component.context),
                            (n.dragSelection = null));
                    });
        ...
        function t(n) {
            ...
            (o.subjectEl = null),
                ...
                (o.handlePointerDown = function (e) {
                    ...
                    var u = (o.subjectSeg = Kn(e.subjectEl)),
                        c = (o.eventRange = u.eventRange).instance.instanceId;
                    (o.relevantEvents = En(l.getCurrentData().eventStore, c)),
                        ...
                        s.fixedMirrorParent
                            ...
                            : (a.parentNode = Ce(t, ".fc")),
                        (a.revertDuration = s.dragRevertDuration);
                    var d =
                        r.isValidSegDownEl(t) && !Ce(t, ".fc-event-resizer");
                    i.setIgnoreMove(!d),
                        (o.isDragging =
                            d &&
    ...
    var Os = (function (e) {
        function t(t) {
            ...
            (n.draggingSegEl = null),
                ...
                (n.handleHitUpdate = function (e, t, r) {
                    ...
                    l &&
                        ((u = mr(i, o.getCurrentData().eventUiBases, l, o)),
                        (d.mutatedEvents = u),
                ...
                (n.handleDragEnd = function (e) {
                    ...
                    if (
                        ...
                        t.emitter.trigger(
                            ...
                            r(r({}, c), {
                                el: n.draggingSegEl,
                                startDelta: n.validMutation.startDelta || It(0),
                                endDelta: n.validMutation.endDelta || It(0),
                                jsEvent: e.origEvent,
                                view: t.viewApi,
                            })
                        ),
        ...
        return (
            ...
            (t.prototype.querySegEl = function (e) {
                return Ce(e.subjectEl, ".fc-event");
            }),
            t
        );
    })(Yi);
                ...
                (this.context = e),
                    ...
                    (this.onDocumentPointerDown = function (e) {
                        var n = t.context.options.unselectCancel,
                            r = e.origEvent.target;
                        (t.matchesCancel = !!Ce(r, n)),
                            (t.matchesEvent = !!Ce(r, Hs.SELECTOR));
                    }),
                            ...
                            n.canDropElOnCalendar(o.subjectEl, a) &&
                                ((s = (function (e, t, n) {
                                    ...
                                    var f = t.duration
                                            ...
                                            : gr(e.allDay, p, n),
                                        h = vt(d.defId, { start: p, end: f });
                                    return { def: d, instance: h };
                                })(e.dateSpan, n.dragMeta, a)),
                                (u.mutatedEvents = yn(s)),
    ...
    var Vs = (function () {
        ...
        Bs = Uo({
            componentInteractions: [Ps, Ns, Hs, Os],
            ...
            return (
                ...
                (t.prototype.renderSimpleLayout = function (e, t) {
                    ...
                    return (
                        ...
                        So(Xo, { viewSpec: r.viewSpec }, function (e, t) {
                            return So(
                                "div",
                                {
                                    ref: e,
                ...
                (t.prototype.renderHScrollLayout = function (e, t, n, r) {
                    ...
                    return (
                        ...
                        So(Xo, { viewSpec: a.viewSpec }, function (e, t) {
                            return So(
                                "div",
                                {
                                    ref: e,
            ...
            (t.prototype.render = function () {
                var e = this.props,
                    t = this.context.options.navLinks
                        ? { "data-navlink": to(e.date), tabIndex: 0 }
                        : {};
                return So(
                    Qa,
                    {
            ...
            return (
                ...
                (t.prototype.render = function () {
                    var e = this.props,
                        ...
                        o = or(e.seg, n, t, !0, e.defaultDisplayEventEnd);
                    return So(
                        Za,
                        {
                            seg: e.seg,
        ...
        ol = (function (e) {
            function t() {
                ...
                return (
                    (t.rootElRef = bo()),
                    (t.handleRootEl = function (e) {
                        Oo(t.rootElRef, e), Oo(t.props.elRef, e);
                    }),
                    t
                );
            }
            return (
                ...
                (t.prototype.render = function () {
                    var e = this.props,
                        ...
                        a = e.dateProfile,
                        s = o.navLinks
                            ? { "data-navlink": to(i, "week"), tabIndex: 0 }
                            : {};
                    return So(
                        ts,
                        {
                ...
                f = (function (e, t, n) {
                    for (
                        var r = (function (e, t) {
                                ...
                                for (var o = 0, i = e; o < i.length; o++) {
                                    var a = i[o];
                                    for (r = a.spanStart; r < a.spanEnd; r += 1)
                                        n[r].push(a);
                                }
                                return n;
                            })(e, n.length),
                        ...
                        for (var m = 0, y = l; m < y.length; m++) {
                            (h = y[m]), (v = t[h.segInput.index]);
                            var E = h.spanEnd - h.spanStart > 1,
                                S = h.spanStart === s;
                            (d += h.levelCoord - c),
                                (c = h.levelCoord + h.thickness),
                                E
                                    ...
                                    : S &&
                                      (g.push({
                                          seg: al(v, h.spanStart, h.spanEnd, n),
                                          isVisible: !0,
                                          isAbsolute: !1,
                                          absoluteTop: 0,
                                          marginTop: d,
    ...
    function al(e, t, n, o) {
        ...
        var i = e.eventRange,
            a = i.range,
            s = zn(a, { start: o[t].date, end: Qe(o[n - 1].date, 1) });
        return r(r({}, e), {
            firstCol: t,
            lastCol: n - 1,
            eventRange: {
                        ...
                        for (var l = t.lateralStart; l < t.lateralEnd; l += 1) {
                            ...
                            if (this.allowReslicing) {
                                ...
                                a[(d = Bi(c))] ||
                                    ((a[d] = !0),
                                    (i[s][l] = c),
                                    this.splitEntry(u, n, o));
                            } else {
                                var d;
                                a[(d = Bi(u))] || ((a[d] = !0), o.push(u));
                            }
                        }
            ...
            return (
                ...
                (t.prototype.render = function () {
                    var e = this,
                        ...
                        o = t.cells.length,
                        i = qs(t.businessHourSegs, o),
                        a = qs(t.bgEventSegs, o),
                        s = qs(this.getHighlightSegs(), o),
                        l = qs(this.getMirrorSegs(), o),
                        u = il(
                            Qn(t.fgEventSegs, r.eventOrder),
                            t.dayMaxEvents,
                            t.dayMaxEventRows,
                            r.eventOrderStrict,
                        ...
                        for (var l = 0, u = e; l < u.length; l++) {
                            ...
                            s.push(
                                So(
                                    ...
                                    "bg-event" === t
                                        ? So(rs, r({ seg: c }, ir(c, i)))
                                        : ns(t)
                                )
                            );
                        }
                    return So.apply(void 0, o([Co, {}], s));
                }),
    ...
    ll.addStateEquality({ eventInstanceHeights: bt });
    var ul = (function (e) {
        function t() {
            var t = (null !== e && e.apply(this, arguments)) || this;
            return (
                (t.splitBusinessHourSegs = jt(Gs)),
                (t.splitBgEventSegs = jt(Gs)),
                (t.splitFgEventSegs = jt(Gs)),
                (t.splitDateSelectionSegs = jt(Gs)),
                (t.splitEventDrag = jt(Ys)),
                (t.splitEventResize = jt(Ys)),
                (t.rowRefs = new Na()),
                (t.handleRootEl = function (e) {
                    (t.rootEl = e),
                        e
    ...
    var dl = (function (e) {
        ...
        pl = (function (e) {
            function t() {
                var t = (null !== e && e.apply(this, arguments)) || this;
                return (t.slicer = new dl()), (t.tableRef = bo()), t;
            }
            return (
                n(t, e),
                (t.prototype.render = function () {
            ...
            var r = n.dateEnv,
                ...
                a =
                    null == o.slotLabelFormat
                        ...
                        ? an(o.slotLabelFormat[0])
                        : an(o.slotLabelFormat),
                s = {
                    level: 0,
                    time: e.time,
            ...
            return (
                ...
                (t.prototype.render = function () {
                    return this.props.slatMetas.map(function (e) {
                        return So("tr", { key: e.key }, So(yl, r({}, e)));
                    });
                }),
                t
            );
    ...
    var wl = (function () {
            ...
            return (
                (e.prototype.safeComputeTop = function (e) {
                    ...
                    if (qn(t.currentRange, e)) {
                        ...
                        if (r >= At(t.slotMinTime) && r < At(t.slotMaxTime))
                            return this.computeTimeTop(It(r));
                    }
                    return null;
                }),
                (e.prototype.computeDateTop = function (e, t) {
                    return (
                        t || (t = at(e)),
                        this.computeTimeTop(It(e.valueOf() - t.valueOf()))
                    );
                }),
                (e.prototype.computeTimeTop = function (e) {
                    var t,
                        ...
                        i = r.els.length,
                        a =
                            (e.milliseconds - At(o.slotMinTime)) /
                            At(this.slotDuration);
                    return (
                        (a = Math.max(0, a)),
                        (a = Math.min(i, a)),
                        (t = Math.floor(a)),
        ...
        _l = (function (e) {
            function t() {
                var t = (null !== e && e.apply(this, arguments)) || this;
                return (t.rootElRef = bo()), (t.slatElRefs = new Na()), t;
            }
            return (
                n(t, e),
                (t.prototype.render = function () {
                                    ...
                                    (function (e, t, n) {
                                        ...
                                        for (; l < s; l += 1) {
                                            for (
                                                var u = o[l],
                                                    c = void 0,
                                                    d = qi(u, i.spanStart, zi),
                                                    p = d[0] + d[1],
                                                    f = p;
                                                (c = u[f]) &&
                                                c.spanStart < i.spanEnd;
    ...
    var Al = an({ hour: "numeric", minute: "2-digit", meridiem: !1 }),
        Ul = (function (e) {
            function t() {
                return (null !== e && e.apply(this, arguments)) || this;
            }
        ...
        Wl = (function (e) {
            function t() {
                var t = (null !== e && e.apply(this, arguments)) || this;
                return (
                    (t.sortEventSegs = jt(Qn)),
                    (t.computeFgSegPlacements = jt(Il)),
                    t
                );
            }
            return (
                ...
                (t.prototype.renderPositionedFgSegs = function (e, t, n, o, i) {
                    var a = this,
                        ...
                        m = v ? Il(g) : this.computeFgSegPlacements(g, c, l),
                        y = m.segRects,
                        E = m.hiddenGroups;
                    return So(
                        Co,
    ...
    var Fl = (function (e) {
        function t() {
            var t = (null !== e && e.apply(this, arguments)) || this;
            return (
                (t.splitFgEventSegs = jt(Tl)),
                (t.splitBgEventSegs = jt(Tl)),
                (t.splitBusinessHourSegs = jt(Tl)),
                (t.splitNowIndicatorSegs = jt(Tl)),
                (t.splitDateSelectionSegs = jt(Tl)),
                (t.splitEventDrag = jt(kl)),
                (t.splitEventResize = jt(kl)),
                (t.rootElRef = bo()),
                (t.cellElRefs = new Na()),
                t
            );
    ...
    var Xl = (function (e) {
        function t() {
            var t = (null !== e && e.apply(this, arguments)) || this;
            return (
                (t.buildTimeColsModel = jt(Kl)), (t.buildSlatMetas = jt(Zl)), t
            );
        }
        return (
            n(t, e),
    ...
    function Ql(e) {
        ...
        return So(
            Co,
            null,
            e.text && So("a", r({ className: "fc-list-day-text" }, t), e.text),
            e.sideText &&
                So(
                    "a",
    ...
    var eu = an({ hour: "numeric", minute: "2-digit", meridiem: "short" }),
        tu = (function (e) {
            function t() {
                return (null !== e && e.apply(this, arguments)) || this;
            }
            return (
                ...
                (t.prototype.render = function () {
                    var e = this.props,
                        t = this.context,
                        n = e.seg,
                        r = t.options.eventTimeFormat || eu;
                    return So(
                        Za,
                        {
                            seg: n,
    ...
    function nu(e) {
        var t = e.event,
            n = t.url;
        return So("a", r({}, n ? { href: n } : {}), t.title);
    }
    function ru(e) {
        return e.text;
    }
    var ou = (function (e) {
        function t() {
            var t = (null !== e && e.apply(this, arguments)) || this;
            return (
                (t.computeDateVars = jt(au)),
                (t.eventStoreToSegs = jt(t._eventStoreToSegs)),
        ...
        return (
            ...
            (t.prototype.renderSegList = function (e, t) {
                ...
                return So(va, { unit: "day" }, function (e, n) {
                    for (var s = [], l = 0; l < a.length; l += 1) {
                        var u = a[l];
                        if (u) {
                            var c = t[l].toISOString();
                            s.push(
                                So(Jl, { key: c, dayDate: t[l], todayRange: n })
                            );
                            for (
                                var d = 0, p = (u = Qn(u, i.eventOrder));
                                d < p.length;
                                d++
                            ) {
                                var f = p[d];
    ...
    function au(e) {
        for (
            ...
            r.push(t), o.push({ start: t, end: Qe(t, 1) }), (t = Qe(t, 1));
    ...
    var cu = Uo({ themeClasses: { bootstrap: uu } });
    var du = Uo({
        eventSourceDefs: [
            {
                parseMeta: function (e) {
                            ...
                            p = (function (e, t, n, o) {
                                ...
                                o.canComputeOffset
                                    ? ((a = o.formatIso(e.start)),
                                      (s = o.formatIso(e.end)))
                                    : ((a = Qe(e.start, -1).toISOString()),
                                      (s = Qe(e.end, 1).toISOString()));
                                (i = r(r({}, n || {}), {
                                    key: t,
                                    timeMin: a,
                                    timeMax: s,
    ...
    return (
        bi.push(Bs, vl, $l, lu, cu, du),
        (e.BASE_OPTION_DEFAULTS = ln),
        ...
        (e.DayTableSlicer = dl),
        (e.DayTimeCols = Gl),
        (e.DayTimeColsSlicer = jl),
        (e.DayTimeColsView = Xl),
        (e.DelayedRunner = Ri),
        (e.Draggable = Vs),
        (e.ElementDragging = $i),
        (e.ElementScrollController = go),
        (e.Emitter = fo),
        (e.EventApi = _r),
        (e.EventRoot = Za),
        (e.EventSourceApi = De),
        ...
        (e.TimeColsView = bl),
        (e.ViewApi = Sr),
        (e.ViewContextType = xo),
        (e.ViewRoot = Xo),
        (e.WeekNumberRoot = is),
        (e.WindowScrollController = mo),
        (e.addDays = Qe),
        (e.addDurations = Nt),
        (e.addMs = et),
        (e.addWeeks = Je),
        ...
        (e.buildIsoString = Wt),
        (e.buildNavLinkData = to),
        (e.buildSegCompareObj = er),
        (e.buildSegTimeText = or),
        (e.buildSlatMetas = Zl),
        (e.buildTimeColsModel = Kl),
        (e.collectFromHash = _t),
        (e.combineEventUis = Tn),
        (e.compareByFieldSpec = Ge),
        (e.compareByFieldSpecs = je),
        (e.compareNumbers = Ze),
        (e.compareObjs = wt),
        ...
        (e.computeRect = uo),
        (e.computeSegDraggable = tr),
        (e.computeSegEndResizable = rr),
        (e.computeSegStartResizable = nr),
        (e.computeShrinkWidth = Ha),
        (e.computeSmallestCellWidth = Ke),
        ...
        (e.createDuration = It),
        (e.createElement = So),
        (e.createEmptyEventStore = Sn),
        (e.createEventInstance = vt),
        (e.createEventUi = _n),
        (e.createFormatter = an),
        (e.createPlugin = Uo),
        (e.createPortal = Ro),
        (e.createRef = bo),
        (e.diffDates = Wn),
        ...
        (e.elementMatches = we),
        (e.enableCursor = Le),
        (e.eventTupleToStore = yn),
        (e.filterEventStoreDefs = bn),
        (e.filterHash = yt),
        ...
        (e.getCanVGrowWithinCell = Xr),
        (e.getClippingParents = co),
        (e.getDateMeta = Qr),
        (e.getDayClassNames = eo),
        (e.getDefaultEventEnd = gr),
        (e.getElSeg = Kn),
        (e.getEntrySpanEnd = zi),
        (e.getEventClassNames = ar),
        (e.getIsRtlScrollbarOnLeft = oo),
        (e.getRectCenter = Yr),
        (e.getRelevantEvents = En),
        ...
        (e.getUnequalProps = Ct),
        (e.globalLocales = Or),
        (e.globalPlugins = bi),
        (e.greatestDurationDenominator = Lt),
        ...
        (e.isDateSpansEqual = cr),
        (e.isInt = Xe),
        (e.isInteractionValid = Ca),
        (e.isMultiDayRange = Ln),
        (e.isPropsEqual = bt),
        (e.isPropsValid = _a),
        (e.isValidDate = ft),
        ...
        (e.padStart = Ye),
        (e.parseBusinessHours = Br),
        (e.parseClassNames = Cn),
        (e.parseDragMeta = ea),
        (e.parseEventDef = On),
        (e.parseFieldSpecs = Be),
        (e.parseMarker = Nr),
        (e.pointInsideRect = jr),
        (e.preventContextMenu = Fe),
        (e.preventDefault = Me),
        (e.preventSelection = We),
        (e.rangeContainsMarker = qn),
        (e.rangeContainsRange = Gn),
        (e.rangesEqual = Bn),
        (e.rangesIntersect = jn),
        (e.refineEventDef = Nn),
        (e.refineProps = vn),
        (e.removeElement = be),
        ...
        (e.triggerDateSelect = hr),
        (e.unmountComponentAtNode = To),
        (e.unpromisify = po),
        (e.version = "5.7.0"),
        (e.whenTransitionDone = He),
