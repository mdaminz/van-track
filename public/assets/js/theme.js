    ...
    if (window.countUp) {
        ...
        countups.forEach(function (node) {
            var _utils$getData = utils.getData(node, "countup"),
                ...
                options = _objectWithoutProperties(_utils$getData, [
                    "endValue",
                ]);
            ...
            var getDefaultOptions = function getDefaultOptions() {
                return {
                    ...
                    step: function step(state, circle) {
                        ...
                        circle.setText(
                            "<span class='value'>"
                                .concat(percentage, "<b>%</b></span> <span>")
                                .concat(userOptions.text || "", "</span>")
                        );
                    },
                };
            };
...
var realTimeUsersChartInit = function realTimeUsersChartInit() {
    ...
    if ($echartsRealTimeUsers) {
        ...
        // const totalStudents = window.Laravel?.totalStudents || 0;
